            ...
            <div className="container">
                <div className="-mx-4 flex flex-wrap">
                    <div className="w-full px-4">
                        <div className="mb-4 rounded-md bf-primary/[3%] py-11 px-8 dark:bg-dark sm:p-[50px] lg:mb-5 lg:px-8 xl:p-[55px]">
                    ...
                    <section className="px-[80px] w-full pb-[120px]">
                        <div className="container">
                            <div className="-mx-4 flex flex-wrap">
                                {
                                    searchResults && searchResults.length
                                        ? searchResults.map((searchBlogItem: Blog) =>
                                            <div
                                                ...
                                                <SingleBlog handleDelete={handleDelete} blogItem={searchBlogItem} />
                                            </div>)
                                        : <h1>No blog found!</h1>
                                }
                            </div>
